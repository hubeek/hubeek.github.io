...
<div class="Box Box--condensed box-shadow">
  <div class="Box-header js-wiki-toggle-collapse" style="cursor: pointer">
    <h3 class="Box-title">
      ...
      Pages <span class="Counter Counter--gray">10</span>
    </h3>
  </div>
  <div class=" js-wiki-sidebar-toggle-display">
    ...
    <ul class="m-0 p-0 list-style-none" data-filterable-for="wiki-pages-filter" data-filterable-type="substring">
        <li class="Box-row">
          <strong><a class="d-block" href="/adam-p/markdown-here/wiki">Home</a></strong>
        </li>
        <li class="Box-row">
          <strong><a class="d-block" href="/adam-p/markdown-here/wiki/Compatibility">Compatibility</a></strong>
        </li>
        <li class="Box-row">
          <strong><a class="d-block" href="/adam-p/markdown-here/wiki/Development-Notes">Development Notes</a></strong>
        </li>
        <li class="Box-row">
          <strong><a class="d-block" href="/adam-p/markdown-here/wiki/Markdown-Cheatsheet">Markdown Cheatsheet</a></strong>
        </li>
        <li class="Box-row">
          <strong><a class="d-block" href="/adam-p/markdown-here/wiki/Markdown-Here-Cheatsheet">Markdown Here Cheatsheet</a></strong>
        </li>
        <li class="Box-row">
          <strong><a class="d-block" href="/adam-p/markdown-here/wiki/Other-Markdown-Tools">Other Markdown Tools</a></strong>
        </li>
        <li class="Box-row">
          <strong><a class="d-block" href="/adam-p/markdown-here/wiki/Press,-Posts,-Reviews,-Etc.">Press, Posts, Reviews, Etc.</a></strong>
        </li>
        <li class="Box-row">
          <strong><a class="d-block" href="/adam-p/markdown-here/wiki/Reviews">Reviews</a></strong>
        </li>
        <li class="Box-row">
          <strong><a class="d-block" href="/adam-p/markdown-here/wiki/Tips-and-Tricks">Tips and Tricks</a></strong>
        </li>
        <li class="Box-row">
          <strong><a class="d-block" href="/adam-p/markdown-here/wiki/Troubleshooting">Troubleshooting</a></strong>
        </li>
    </ul>
  </div>
</div>
      ...
      <div class="width-full input-group">
        <input id="wiki-clone-url" type="text" data-autoselect="" class="form-control input-sm text-small text-gray input-monospace" aria-label="Clone URL for this wiki" value="https://github.com/adam-p/markdown-here.wiki.git" readonly="readonly">
